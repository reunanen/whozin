...
INCLUDEPATH += Numcore_messaging_library/messaging/num0w/libzmq/include
INCLUDEPATH += Numcore_messaging_library/messaging/num0w/libzmq/src
INCLUDEPATH += Numcore_messaging_library/messaging/num0w/libzmq/builds/msvc
